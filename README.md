...
You can then run the compiled `.wasm` file as you would the normal binary and cli detailed above; by using [wasmtime](https://docs.wasmtime.dev/cli-install.html).  
