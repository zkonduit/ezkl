...
>() -> (Vec<[F; T]>, Mds<F, T>, Mds<F, T>) {
    ...
    let mut grain = crate::circuit::poseidon::grain::Grain::new(
        crate::circuit::poseidon::grain::SboxType::Pow,
        T as u16,
        r_f as u16,
        r_p as u16,
    );
    ...
    let (mds, mds_inv) =
        crate::circuit::poseidon::mds::generate_mds::<F, T>(&mut grain, S::secure_mds());
