...
def test_table_1l_average():
    ...
    expected_table = \
        """+-------+-----------------------------------------------------------------+----------+-----------+-------------+-----------------+--------+-------------+-----------+-----+
| usize | opkind                                                          | in_scale | out_scale | const_value | raw_const_value | inputs | in_dims     | out_dims  | idx |
+-------+-----------------------------------------------------------------+----------+-----------+-------------+-----------------+--------+-------------+-----------+-----+
| 0     | input                                                           | 7        | 7         |             |                 |        | [[1, 5, 5]] | [1, 5, 5] | 0   |
+-------+-----------------------------------------------------------------+----------+-----------+-------------+-----------------+--------+-------------+-----------+-----+
| 1     | padding: (0, 0)                                                 | 7        | 7         |             |                 | [0]    | [[1, 5, 5]] | [1, 5, 5] | 1   |
+-------+-----------------------------------------------------------------+----------+-----------+-------------+-----------------+--------+-------------+-----------+-----+
| 2     | avg pl w/ padding: (0, 0), stride: (1, 1), kernel shape: (3, 3) | 7        | 7         |             |                 | [1]    | [[1, 5, 5]] | [1, 3, 3] | 2   |
+-------+-----------------------------------------------------------------+----------+-----------+-------------+-----------------+--------+-------------+-----------+-----+"""
